...
export default {
  com_nav_convo_menu_options: 'Опции за мени на разговор',
  com_ui_artifacts: 'Артефакти',
  com_ui_artifacts_toggle: 'Вклучи/исклучи артефакти',
  com_nav_info_code_artifacts:
    'Овозможува прикажување на експериментални кодни артефакти покрај чата',
  com_ui_include_shadcnui: 'Вклучи упатства за shadcn/ui компоненти',
  com_nav_info_include_shadcnui:
    'Кога е вклучено, упатствата за користење на shadcn/ui компоненти ќе бидат вклучени. shadcn/ui е колекција на повторно употребливи компоненти изградени со користење на Radix UI и Tailwind CSS. Забелешка: овие се долги упатства, треба да ги вклучите само ако информирањето на LLM за правилните увози и компоненти е важно за вас. За повеќе информации за овие компоненти, посетете: https://ui.shadcn.com/',
  com_ui_custom_prompt_mode: 'Режим на прилагоден промпт',
  com_nav_info_custom_prompt_mode:
    'Кога е вклучено, стандардниот системски промпт за артефакти не ќе биде вклучен. Сите инструкции за генерирање артефакти мора да бидат дадени рачно во овој режим.',
  com_ui_artifact_click: 'Кликни за да отвориш',
  com_a11y_start: 'Вештачката интелигенција почнала да одговара.',
  com_a11y_ai_composing: 'Вештачката интелигенција сè уште составува.',
  com_a11y_end: 'Вештачката интелигенција го заврши својот одговор.',
  com_error_moderation:
    'Изгледа дека содржината што беше испратена е обележана од нашиот модераторски систем поради тоа што не се совпаѓа со нашите правила на заедницата. Не можеме да продолжиме со оваа конкретна тема. Ако имате некои други прашања или теми што сакате да истражите, молам измените ја вашата порака или создадете нов разговор.',
  com_error_no_user_key: 'Не е пронајден клуч. Ве молиме внесете клуч и обидете се повторно.',
  com_error_no_base_url:
    'Не е пронајдена основна URL адреса. Ве молиме внесете една и обидете се повторно.',
  com_warning_resubmit_unsupported:
    'Повторното испраќање на порака од вештачка интелигенција не е поддржано за оваа точка на крајот.',
  com_error_invalid_request_error:
    'Услугата за вештачка интелигенција ја отфрли побараната поради грешка. Ова може да биде предизвикано од невалиден API клуч или неправилно форматирана побарана.',
  com_error_no_system_messages:
    'Избраната услуга или модел на вештачка интелигенција не поддржуваат системски пораки. Обидете се да користите промпти наместо прилагодени упатства.',
  com_error_invalid_user_key:
    'Внесениот клуч е невалиден. Ве молам внесете валиден клуч и обидете се повторно.',
  com_error_expired_user_key:
    'Внесениот клуч за {0} истече на {1}. Ве молам внесете нов клуч и обидете се повторно.',
  com_error_input_length:
    'Бројот на токени во последната порака е премногу долг, ја надминува границата за токени ({0} соответно). Ве молам скратете ја вашата порака, прилагодете ја максималната големина на контекстот од параметрите на разговорот или одвојте го разговорот за да продолжите.',
  com_error_files_empty: 'Празни фајлови не се дозволени.',
  com_error_files_dupe: 'Дупликат фајл е пронајден.',
  com_error_files_validation: 'Се случи грешка при валидација на фајлот.',
  com_error_files_process: 'Се случи грешка при процесирање на фајлот.',
  com_error_files_upload: 'Се случи грешка при качување на фајлот.',
  com_error_files_upload_canceled:
    'Побараното качување на фајлот беше откажано. Забелешка: побарувањето за качување на фајлот може сè уште да се процесира и ќе мора да биде рачно избришано.',
  com_files_no_results: 'Без резултати.',
  com_files_filter: 'Филтрирај фајлови...',
  com_generated_files: 'Генерирани фајлови:',
  com_download_expired: '(качувањето истече)',
  com_download_expires: '(кликнете тука за да преземете - истекува {0})',
  com_click_to_download: '(кликнете тука за да преземете)',
  com_files_number_selected: '{0} од {1} фајл(ови) се избрани',
  com_sidepanel_select_assistant: 'Избери Асистент',
  com_sidepanel_parameters: 'Параметри',
  com_sidepanel_assistant_builder: 'Градежник на Асистент',
  com_sidepanel_hide_panel: 'Скриј Панел',
  com_sidepanel_attach_files: 'Прикачи Фајлови',
  com_sidepanel_manage_files: 'Управувај со Фајлови',
  com_sidepanel_conversation_tags: 'Обележувачи',
  com_assistants_capabilities: 'Можности',
  com_assistants_file_search: 'Пребарување на Фајлови',
  com_assistants_file_search_info:
    'Пребарувањето на фајлови му овозможува на асистентот да биде информиран со знаење од фајловите што вие или вашите корисници ги прикачуваат. Откако фајлот ќе биде прикачен, асистентот автоматски ќе одлучува кога да земе содржина врз основа на барањата на корисниците. Прикачувањето на векторски бази за Пребарување на фајлови засега не е поддржано. Можете да ги прикачите од Плајгроундот на Провајдерот или да прикрепите фајлови на пораки за пребарување на фајлови на основа на нишка.',
  com_assistants_code_interpreter_info:
    'Интерпретаторот на код овозможува на асистентот да пишува и изведува код. Овој алат може да процесира фајлови со различни податоци и форматирање, и да генерира фајлови како графикони.',
  com_assistants_knowledge: 'Знаење',
  com_assistants_knowledge_info:
    'Ако прикачите фајлови под Знаење, разговорите со вашиот Асистент можат да вклучуваат содржина од фајловите.',
  com_assistants_knowledge_disabled:
    'Асистентот мора да биде создаден, и Интерпретаторот на кодот или Повратот мора да бидат вклучени и зачувани пред да се прикачат фајлови како Знаење.',
  com_assistants_image_vision: 'Вид на слики',
  com_assistants_code_interpreter: 'Интерпретатор на код',
  com_assistants_code_interpreter_files: 'Фајловите подолу се само за Интерпретатор на код:',
  com_assistants_retrieval: 'Повраток',
  com_assistants_search_name: 'Пребарајте асистенти по име',
  com_ui_tools: 'Алатки',
  com_assistants_actions: 'Акции',
  com_assistants_add_tools: 'Додај Алатки',
  com_assistants_add_actions: 'Додај Акции',
  com_assistants_non_retrieval_model:
    'Пребарувањето на фајлови не е вклучено на оваа форма. Ве молиме изберете друга форма.',
  com_assistants_available_actions: 'Достапни Акции',
  com_assistants_running_action: 'Извршување на акција',
  com_assistants_completed_action: 'Разговарано со {0}',
  com_assistants_completed_function: 'Извршено {0}',
  com_assistants_function_use: 'Асистентот ја користеше {0}',
  com_assistants_domain_info: 'Асистентот испрати оваа информација на {0}',
  com_assistants_delete_actions_success: 'Успешно избришана акција од асистентот',
  com_assistants_update_actions_success: 'Успешно создадена или ажурирана акција',
  com_assistants_update_actions_error: 'Имаше грешка при создавањето или ажурирањето на акцијата.',
  com_assistants_delete_actions_error: 'Имаше грешка при бришењето на акцијата.',
  com_assistants_actions_info:
    'Овозможете на вашиот асистент да прибира информации или да презема акции преку API-ја',
  com_assistants_name_placeholder: 'Опционално: Името на асистентот',
  com_assistants_instructions_placeholder: 'Системските упатства што ги користи асистентот',
  com_assistants_description_placeholder: 'Опционално: Опишете го вашиот асистент тука',
  com_assistants_actions_disabled: 'Морате да создадете асистент пред да додадете акции.',
  com_assistants_update_success: 'Успешно ажурирано',
  com_assistants_update_error: 'Имаше грешка при ажурирањето на вашиот асистент.',
  com_assistants_create_success: 'Успешно создадено',
  com_assistants_create_error: 'Имаше грешка при создавањето на вашиот асистент.',
  com_assistants_conversation_starters: 'Започнувачи на разговори',
  com_assistants_conversation_starters_placeholder: 'Внесете почеток на разговор',
  com_sidepanel_agent_builder: 'Градежник на Агент',
  com_agents_name_placeholder: 'Опционално: Името на агентот',
  com_agents_description_placeholder: 'Опционално: Опишете го вашиот агент тука',
  com_agents_instructions_placeholder: 'Системските упатства што ги користи агентот',
  com_agents_search_name: 'Пребарајте агенти по име',
  com_agents_update_error: 'Имаше грешка при ажурирањето на вашиот агент.',
  com_agents_create_error: 'Имаше грешка при создавањето на вашиот агент.',
  com_agents_missing_provider_model:
    'Ве молиме изберете провајдер и модел пред да создадете агент.',
  com_agents_allow_editing: 'Овозможи на другите корисници да го уредуваат вашиот агент',
  com_agents_not_available: 'Агентот не е достапен',
  com_agents_no_access: 'Немате пристап за уредување на овој агент.',
  com_agents_enable_file_search: 'Овозможи Пребарување на Фајлови',
  com_agents_file_search_info:
    'Кога е овозможено, агентот ќе биде информиран за точните имиња на фајловите наведени подолу, што му овозможува да прибира релевантен контекст од овие фајлови.',
  com_agents_file_search_disabled:
    'Агентот мора да биде создаден пред да се прикачат фајлови за Пребарување на фајлови.',
  com_agents_execute_code: 'Изврши Код',
  com_ui_agent_already_shared_to_all: 'Овој агент веќе е споделен со сите корисници',
  com_ui_agent_editing_allowed: 'Други корисници веќе можат да го уредуваат овој агент',
  com_ui_no_changes: 'Нема промени за ажурирање',
  com_ui_date_today: 'Денес',
  com_ui_date_yesterday: 'Вчера',
  com_ui_date_previous_7_days: 'Претходни 7 дена',
  com_ui_date_previous_30_days: 'Претходни 30 дена',
  com_ui_date_january: 'Јануари',
  com_ui_date_february: 'Февруари',
  com_ui_date_march: 'Март',
  com_ui_date_april: 'Април',
  com_ui_date_may: 'Мај',
  com_ui_date_june: 'Јуни',
  com_ui_date_july: 'Јули',
  com_ui_date_august: 'Август',
  com_ui_date_september: 'Септември',
  com_ui_date_october: 'Октомври',
  com_ui_date_november: 'Ноември',
  com_ui_date_december: 'Декември',
  com_ui_field_required: 'Ова поле е задолжително',
  com_ui_download_error: 'Грешка при преземање на фајлот. Можеби фајлот е избришан.',
  com_ui_attach_error_type: 'Неподдржан тип на фајл за точката:',
  com_ui_attach_error_openai: 'Не може да се прикачат фајлови од Асистентот на други точки',
  com_ui_attach_warn_endpoint:
    'Фајловите кои не се од Асистентот можат да бидат игнорирани без компатибилен алат',
  com_ui_attach_error_size: 'Преминат е лимитот за големина на фајлот за точката:',
  com_ui_attach_error:
    'Не може да се прикачи фајл. Создајте или изберете разговор, или обидете се да ја освежите страницата.',
  com_ui_examples: 'Примери',
  com_ui_new_chat: 'Нов разговор',
  com_ui_happy_birthday: 'Ја славам својата прва годишнина!',
  com_ui_experimental: 'Експериментални Функции',
  com_ui_on: 'Вклучено',
  com_ui_off: 'Исклучено',
  com_ui_yes: 'Да',
  com_ui_no: 'Не',
  com_ui_ascending: 'Растечки',
  com_ui_descending: 'Опаднти',
  com_ui_show_all: 'Прикажи Сè',
  com_ui_name: 'Име',
  com_ui_date: 'Дата',
  com_ui_storage: 'Складиште',
  com_ui_context: 'Контекст',
  com_ui_size: 'Големина',
  com_ui_host: 'Хост',
  com_ui_update: 'Ажурирај',
  com_ui_authentication: 'Автентикација',
  com_ui_instructions: 'Упатства',
  com_ui_description: 'Опис',
  com_ui_error: 'Грешка',
  com_ui_error_connection:
    'Грешка при поврзување со серверот, обидете се да ја освежите страницата.',
  com_ui_select: 'Избери',
  com_ui_input: 'Внеси',
  com_ui_close: 'Затвори',
  com_ui_endpoint: 'Точка на крајот',
  com_ui_provider: 'Провајдер',
  com_ui_model: 'Модел',
  com_ui_region: 'Регион',
  com_ui_model_parameters: 'Параметри на моделот',
  com_ui_model_save_success: 'Параметрите на моделот успешно зачувани',
  com_ui_select_model: 'Изберете модел',
  com_ui_select_region: 'Изберете регион',
  com_ui_select_provider: 'Изберете провајдер',
  com_ui_select_provider_first: 'Прво изберете провајдер',
  com_ui_select_search_model: 'Пребарај модел по име',
  com_ui_select_search_region: 'Пребарај регион по име',
  com_ui_select_search_plugin: 'Пребарај приклучок по име',
  ...
  com_nav_lang_macedonian: 'Македонски',
